...
Hiukan suppeita ehkä (en tosin pyytänyt lisäämään testejä), mutta muuten ok.
...
En huomannut muutoksia aiemmissa moduleissa, se vaan lisäsi `web_app.py`-modulin, jossa web ui -logiikka. Lisäksi `tests`-hakemisto testeille, ja `README.md` (se ehdotti, että voisi kirjoittaa readme:n, ja sanoin "ok").
